...
async def _list_tools() -> List[types.Tool]:
    ...
    return [
        types.Tool(
            name="say_hello",
            title="Say Hello",
            description="Greets the user with a customizable hello message",
            inputSchema={
                "type": "object",
                "properties": {
                    "name": {
...
async def _call_tool_request(
    ...
    if tool_name == "say_hello":
        ...
        data = {
            ...
            "name": name,
            "timestamp": "now",
            "message": "Welcome to the hello world app!",
        }
        ...
        return types.CallToolResult(
            content=[
                types.TextContent(
                    type="text",
                    text=f"Hello, {name}! Welcome to the hello world app. See the interactive greeting below.",
                )
            ],
            structuredContent={
